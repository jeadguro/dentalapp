...
import { Home, Users, Calendar, FileText, LogOut, Menu, X, ChevronRight, User, Settings } from 'lucide-react';

const navigation = [
  { name: 'Dashboard', href: '/admin/dashboard', icon: Home },
  { name: 'Pacientes', href: '/admin/patients', icon: Users },
  { name: 'Consultas', href: '/admin/consultations', icon: FileText },
        ...
        <div className="flex flex-col h-full">
          <div className="flex items-center justify-between h-16 px-6 border-b border-gray-100">
            <Link to="/admin/dashboard" className="flex items-center gap-3">
              ...
              <span className="font-bold text-lg text-gray-900">DentalCare<span className="text-teal-600 ml-1">Pro</span></span>
            </Link>
          ...
          <div className="p-4 border-t border-gray-100">
            ...
            <button 
              ...
              className="mt-3 w-full flex items-center justify-center gap-2 px-4 py-2.5 text-red-600 hover:bg-red-50 rounded-xl transition-colors"
            >
