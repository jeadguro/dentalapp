      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="font-display font-bold text-2xl text-gray-900">DentalCare<span className="text-teal-600 ml-1">Pro</span></span>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200 text-center">
            <p className="text-sm text-gray-500">¿Eres paciente? <Link to="/portal/login" className="text-teal-600 hover:text-teal-700 font-medium">Accede aquí</Link></p>
          </div>
        </div>
      </div>
